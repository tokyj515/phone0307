<template>
    <v-card outlined>
        ...
        <v-card-text style="background-color: white;">
            <Number v-if="editMode" label="ReportId" v-model="value.reportId" :editMode="editMode" :inputUI="''"/>
        ...
        <v-card-actions style="background-color: white;">
            ...
            <div v-else>
                ...
                <v-btn
                    ...
                    @click="save"
                >
                    RequestLostReportCancelAtStore
                </v-btn>
                <v-btn
                    color="primary"
                    text
